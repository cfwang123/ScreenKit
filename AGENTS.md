...
7. 修改大或复杂问题时，记录到 mydocs/TODO.md，并随修改过程更新。设计相关文件同样放在 mydocs/ 下；mydocs/ 已记入 .gitignore，不提交。
8. 代码风格指导（按需读取，动手改代码前先对照）
...
10. 同一个问题反复修改还不行时，用命令行/adb+日志自己调试
