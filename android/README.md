...
7. 桌面 **投屏**：扫描同一 Wi‑Fi 上的电脑（或填 IP），允许截屏后把画面推到 ScreenKit。画质三档 540p/720p/1080p，可关声音。电脑需保持投屏接收（默认开）。**USB 投屏**：插上数据线即可，**不用开 USB 调试**。电脑 ScreenKit 把手机切成 USB 配件，手机允许配件后点 **USB 投屏**。
