...
| **投屏** | **工具 → 投屏**（托盘「工具」同样入口）：局域网 / USB 接收手机或另一台电脑画面，也可把本机投出。画质 540p/720p/1080p，可关声音。发现 UDP 19518、媒体 TCP 19519。手机 App 桌面有独立「投屏」图标。 |
...
2. 手机点桌面 **投屏** → 允许截屏 / 麦克风 / 通知 → **扫描** → 选中电脑 → **开始投屏**。也可填 IP，或 USB 调试后点 **USB 投屏**。
