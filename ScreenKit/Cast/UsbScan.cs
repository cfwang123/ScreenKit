...
sealed class CastUsbScan {
	...
	static bool isusb(NetworkInterface ni) {
		...
		return s.Contains("rndis") || s.Contains("remote ndis") || s.Contains("ndis") && s.Contains("internet") ||
			s.Contains("android") || s.Contains("usb ethernet") || s.Contains("usb 以太网") ||
			s.Contains("gadget") || s.Contains("网络共享") || s.Contains("mobile broadband") ||
			s.Contains("远程 ndis") || s.Contains("远程ndis");
	}
}
