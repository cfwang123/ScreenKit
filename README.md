...
1. PC **Tools → Screencast** (receive starts with the app; Settings → API can turn it off). Same Wi‑Fi, not a guest network. Run this repo’s Release exe (not another copy). If TCP 19519 is stuck, the PC listens on 19520+; Scan uses that port.
