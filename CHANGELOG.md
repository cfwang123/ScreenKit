...
- Android title-bar hamburger: **Settings** (bind receive folder) and **Switch PC**. The old on-screen buttons and the text-sync screen are removed.
...
- 安卓标题栏三横菜单：**参数设置**（绑定接收文件夹）、**换电脑**；去掉主界面这两颗按钮，并去掉文本同步页。
