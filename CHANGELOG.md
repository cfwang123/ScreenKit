...
- Screencast: the picture is shown about 0.5s later so it lines up with the sound. Sound plays through instead of being cut.
...
- 投屏：画面大约晚 0.5 秒再显示，以便和声音对齐。声音连续播放，不再被截断。
